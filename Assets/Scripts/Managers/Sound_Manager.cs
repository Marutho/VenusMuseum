...
public class Sound_Manager : MonoBehaviour
{
    ...
    //SOUNDS CORRECT!
    public AudioClip correctMinigame;
    ...
    public static Sound_Manager instance = null;     //Allows other scripts to call functions from SoundManager.             
    ...
    public void Cannon(AudioSource audioSrc)
    {
        instance.PlaySingle(cannon, audioSrc);
    }
